...
HRESULT GenerateSharedToggleElements(ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveNamespace::AdaptiveToggleTarget*>* items,
...
HRESULT GenerateToggleTargetProjection(
    ...
    ABI::Windows::Foundation::Collections::IVector<ABI::AdaptiveNamespace::AdaptiveToggleTarget*>* projectedParentContainer) noexcept;
